...
func checkKafkaProxyProducerConnectivity(h *HealthcheckHandler) health.Check {
	return health.Check{
		...
		PanicGuide:       "https://runbooks.in.ft.com/runbooks/post-publication-combiner",
		Severity:         2,
...
func checkDocumentStoreAPIHealthcheck(h *HealthcheckHandler) health.Check {
	return health.Check{
		...
		PanicGuide:       "https://runbooks.in.ft.com/runbooks/document-store-api",
		Severity:         2,
...
func checkPublicAnnotationsAPIHealthcheck(h *HealthcheckHandler) health.Check {
	return health.Check{
		...
		PanicGuide:       "https://runbooks.in.ft.com/runbooks/annotationsapi",
		Severity:         2,
